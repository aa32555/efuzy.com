...
ADSET ; set up default quetions for ADS interface
 N  D ^SET ;I ^TRMG="DTM",^TRMG($I)="3151"
...
ENV8 D HDR^BOX(25,70,15,23," Enter Text to Print on Envelope ") F I=1:1:5 S CH="" D ENV4 Q:$ZB=Q
 ...
 Q
ENV5 Q
ENV6 S PR=^ZAA02GADS("LPT") I PR="O" D RD^BOX(10,76,22," Enter Printer Number: ","",2) Q:$ZB=Q  S PR=A I A="" W *7 G ENV6
