ZAA02GFAXU4 ;PG&A,ZAA02G-FAX,1.36,UTILITY;27JUL95 8:26A
 ...
 I TC'["." S TJ=$S(TN'["`":"",TA'["*"&$L(TA):"",TW-$L(TA)<35:"NXT/PRV KEYS",TMM=0:"Next Screen",TO="":"Previous/First Screen",1:"Next/Previous/First Screen"),TA=$P(TA,"*")_TJ_$P(TA,"*",2) I TA]"" S %R=TT+TL+1,%C=-$L(TA)+TW\2+TC(1) W @ZAA02GP,$TR(TA,"*","")
 S TOO=TO,TMM=TM,TA=TI-1,TI=TD,TJ="",TO=TE S:TI>TA TI=TA G:TP["W" WRITONLY
 I TH?."\",TN'["`" S:'$D(X) X="" S:'$D(TX) TX="" S %C=TF+$L(TX)+2,%R=TT+TL W @ZAA02GP,X I TQN="Y" S:$D(LNG)=0 LNG=TW-$L(TX)-2 S FNC=$S('$D(Y(0)):"",1:$P(Y(0),"\",2)),TIM=TMN X ^ZAA02GREAD S:FNC'="" TJ=";"_FNC G SEL4
...
END W ZAA02G("Z") X ^ZAA02G("ECHO-ON") K TA,TB,TC,TD,TE,TF,TG,TH,TI,TJ,TL,TM,TN,TO,TOO,TP,TQ,TQN,TR,TS,TSP,TT,TU,TV,TW,TX,TY,TZ,ZF,TRO,TMM,TMN,TEN,TFK,TDP,TOV,TQF,TVL Q
...
SEL2 I TE?1P S X=+$O(TB(X)),ZF=34 G TT:'$D(TB(X)),SEL0
 ...
 S TG="\" G SEL0
SEL3 G SEL5:TN'["`" I ZF=39 G SEL5:TOO="",MNX^ZAA02GFAXU3
 I ZF=40 G MPR^ZAA02GFAXU3:$P(TN,"`",3)>1
 I ZF=41 G MFR^ZAA02GFAXU3:$P(TN,"`",3)>1
SEL5 G SEL0:TP'["W"
