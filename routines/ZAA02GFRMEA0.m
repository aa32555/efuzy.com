ZAA02GFRMEA0 ;PG&A,ZAA02G-FORM,2.62,FORMS EDITOR, Help Mess.;14APR94 3:37P
...
10 ;      TABLE PARAMETERS\MNEMONIC REF
 ...
 ;  2= ^LOOKUP(table,X,ptr)="" and
 ;     ^TABLE(table,ptr)=data
 ;Optional Parameters:
 ;   A= Alphanumeric sort on pop-ups.
 ;   D= Do $D(reference) on display
 ;   F= Free text allowed.  Prompts user.
 ;   FN=Free test allowed.  No prompt.
 ;   H= Output Table Text in HELP only.
 ;   K= Pop-up Key Matches
 ;   KE=like K sans pop-up on exact match
