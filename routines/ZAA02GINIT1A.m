ZAA02GINIT1 ;PG&A,ZAA02G-CONFIG,2.25,O.S. PARAMETERS  (PSM);6DEC89 3:12P [ 09/20/97  10:12 AM ];;;03JUN99  21:32
 ;Copyright (C) 1985,7 Patterson, Gray and Assoc., Inc.
 S OS="PSM" W !!,"***> Initializing Operating System Parameters ... ",OS
 S ^ZAA02G("OS")=OS
 S ^("ECHO-ON")="U 0:(:""TR"")"
 S ^("ECHO-OFF")="U 0:(:""TSR"")"
 S ^("TERM-ON")="U 0:(:""TR"") S ZAA02G(1)=ZAA02G(1)+1"
 S ^("TERMST")="S ZF=$ZF"
 S ^("TERM-OFF")="S ZAA02G(1)=ZAA02G(1)-1 U:'ZAA02G(1) 0:(0:"""")"
 S ^("ERROR")="$ZE"
 S ^("ERRORR")="$ZE"
 S ^("WRAP-ON")="U:'ZAA02G(1) 0:0"
 S ^("WRAP-OFF")="U 0:0"
 S ^("PAD")=$C(0)
