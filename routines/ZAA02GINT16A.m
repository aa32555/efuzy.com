ZAA02GINT16A ;PG&A,ZAA02G-CONFIG,2.25,CRT DEFINITION  (WYSE 60 - ANSI);28MAY92 1:21A [ 09/20/97  10:12 AM ];;;28JUN99  16:41
...
FNC S ^ZAA02G(.1,T,1)="W *27,""[?1;4;68l"",*27,""[4l"",*27,"")0""",^(7)="W *27,*91,""?3h""\W *27,*91,""?3l""\$C(27,91)_""4h""\$C(27,91)_""4l"""
 S ^(2)="27,91,51,50,126`27,91,51,51,126`27,91,51,57,126`27,91,50,54,126`27,91,50,49,126`27,91,49,57,126`27,91,50,52,126`27,91,50,56,126`27,91,90`27,91,49,55,126`27,91,50,50,126`27,91,50,48,126`27,91,50,55,126`27,91,51,52,126`27,91,51,56,126"
 S ^(3)="```````````````27,91,49,56,126`27,91,51,48,126`27,91,51,55,126`27,91,51,49,126`23`27,91,50,57,126`27,91,72```5`1`27,91,51,50,126`27,91,51,51,126"
 S ^(5)="F11`F12`SHIFT F11`SHIFT F5`F5`F3`SHIFT F3`F7`SHIFT TAB`F1`SHIFT F1`F4`F6`SHIFT F6`SHIFT F10",^(6)="```````````````F2`F9`SHIFT F9`F10`CTRL W`F8`HOME`INSERT HERE`REMOVE`CTRL E`Ctrl A`F18`F19"
CLNUP D @(OS_"^ZAA02GINTRM") Q
 ;
DATA ;VT100W;WYSE 60 - VT100 MODE          
 ...
 ;
T S A=17 F I=65:1:74,97:1:103,108:1:114 W *27,"[>",*I,*46,*27,"[",A,*126,*46 S A=A+1 W *I,">",A-1,"  " H 1
 Q
