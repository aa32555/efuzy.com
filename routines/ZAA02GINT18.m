ZAA02GINT18 ;PG&A,ZAA02G-CONFIG,2.25,CRT DEFINITION  (WYSE60-PC);24FEB93 12:58P [ 09/20/97  10:12 AM ];;;28JUN99  16:40
...
ENT W !,?8,"Initializing ",T S M=0,^ZAA02G(0,T,M)="",H=""
 ...
 S:H'="" ^(M)="S "_$E(H,2,255)
FNC S ^ZAA02G(.1,T,1)="G:'$D(ZAA02G(""z"")) INIT^ZAA02GINT18" ;function key load
...
FUNC ;Fn gets mapped to DSM acceptable Fn
 F from=64:1:75 W *27,"z",$C(from),*27,"[",from-47,"~",*127,*27,"z",$C(from+32),*27,"[",from-34,"~",*127
 W *27,"Z",0,*34,*127,*127
 Q
 ;
