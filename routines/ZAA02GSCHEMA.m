ZAA02GSCHEMA ;PG&A,ZAA02G-SCHEMA,1.20,Dictionary Maintenance;23NOV87 4:46P
...
SELECT D SEL G:J=0 EXIT S:'J J=$F(L,J)-1 K L
 I J=1 G CODE
 I J=2 D ^ZAA02GSCHEM2 D:$D(S1) ^ZAA02GSCHEM1:S1'="Q" G BEG
 I J=3 D ^ZAA02GSCHEM3 G BEG
 I J=4 D COPY^ZAA02GSCHEM3 G BEG
 I J=5 D FORMS^ZAA02GSCHEM3 G BEG
 I J=6 D RECOM G BEG
 ;
EXIT W ZAA02G("F") X ^ZAA02G("TERM-OFF"),^ZAA02G("WRAP-ON") Q
 Q
CODE K A,CA D HEAD
CODE1 S %R=5,%C=5,LNG=9,X="",PAT="X?1A.AN!(X?.E1""?"".E)" W @ZAA02GP,ZAA02G("LO"),"Enter Dictionary Code ",ZAA02G("HI"),ZAA02G("CL") S %C=28 X ^ZAA02GREAD G:X="" BEG S S1=X
 I X["?" W !!?10,"Codes may be any string starting with an Alpha character" G CODE1
 D ^ZAA02GSCHEM1 G CODE
 ;
 ;
NA S %R=20 W @ZAA02GP,"OPTION NOT AVAILABLE" H 2 W @ZAA02GP,ZAA02G("CL") Q
HEAD W ZAA02G("F"),ZAA02G("Z") S %R=1,%C=2 W ZAA02G("LO"),@ZAA02GP,ZAA02G("RON")," P ",ZAA02G("RT")," G ",ZAA02G("RT")," & ",ZAA02G("RT")," A " S %C=26 W @ZAA02GP,ZAA02G("ROF"),ZAA02G("HI"),"DATABASE DICTIONARY MANAGEMENT",ZAA02G("LO")
 S %C=68 W @ZAA02GP,ZAA02G("RON"),"  ZAA02GSCHEMA  ",ZAA02G("ROF"),ZAA02G("G1"),! S J=ZAA02G("HL"),J=J_J_J_J F I=1:1:20 W J
 W ZAA02G("G0") Q:$D(NE)  S %R=3,%C=14 W @ZAA02GP,ZAA02G("LO"),"Copyright (C) 1985, Patterson, Gray and Assoc., Inc." Q
 ;
...
DONE K TR,TC,Y,L,X,C X ^ZAA02G("ECHO-ON") Q
 ;
RECOM S %R=3,%C=1,A="RECOMPILE UPDATED FORMS" W @ZAA02GP,ZAA02G("CS"),ZAA02G("Z"),!,?(80-$L(A)\2),A
