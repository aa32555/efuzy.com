ZAA02GSCMRE2 ;PG&A,ZAA02G-MTS,1.20,FORM E WITH changes;;31JAN2003  12:47;;27FEB2001  13:58
...
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 ...
 S %R=7,S=$G(INP("PATIENT"))_"  DOB: "_$G(INP("DOB")),%C=-$L(S)\2+40,W=0,NOCLR=1 W @ZAA02GP,ZAA02G("LO"),S
 I $E($O(ST(0,"")))'="A" S ST(0,"AB")=""
POP1 S (S,Z,W,SY,TS)=0
 S T="STUDY:,9,11;Bilateral,,30,TSB;Left,,42,TSL;Right,,49,TSR" D TT
 S DUP="BLR;SDF;123450;;NF,NB,NT"
 S T="REASON:,11,11;Screening,,30,RAS;Diagnostic,,43,RAP;Follow-up,,57,RAF" D TT
 S T="CATEGORY:,13,11;1 (neg),,30,ABN;2 (benign),,41,ABB;3 (prob benign),,54,ABP;4 (susp),14,30,ABS;5 (malig),,41,ABM;0 (incomplete),,54,ABA" D TT
 S T="FINDINGS:,16,11;Mass,,30,NA0;Suspicious calc.,,36,NAF;Arch. distortion,,54,AAD" D TT
 S T="RECOMMENDATIONS:,18,11;Normal,,30,RCN;Flup (mo),,38,RCF,48,2,PDN;Biopsy,,52,RCB;Surg eval,,60,RCE;Mri,19,30,RCm;Ultrasound/sonogram,,38,RCU;Old films,,60,RCO" D TT
 S T="OTHER:,21,11;Tech,,30,OBT,35,6,PD;Magnification,,43,RCM;Spot compress,,58,RCG" D TT
 S C=X,A="" I $D(BLD) K BLD G ZAA02GSCMRE2
