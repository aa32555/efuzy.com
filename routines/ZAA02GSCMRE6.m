ZAA02GSCMRE6 ;PG&A,ZAA02G-MTS,1.20,ABBREV ENTRY;;;;21OCT97  12:33
 ;Copyright (C) 1996, Patterson, Gray and Associates Inc.
 ;
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 S %R=9,%C=9,B="",$P(B,ZAA02G("HL"),62)="" W @ZAA02GP,ZAA02G("G1"),ZAA02G("HI"),ZAA02G("TLC"),B,ZAA02G("TRC") F %R=%R+1:1:22 W @ZAA02GP,ZAA02G("VL"),$J("",61),ZAA02G("VL")
...
POP1 S (S,Z,W,SY,TS)=0
 ...
 S DUP="LRB;NBPSH;NA,NB,NC,ND,NE,NF,NG,NH,NI,NJ,NL,NM,NO,NP,NR,NS,NT,NU,NV,NX"
 ...
 S T="RECOMMENDATIONS:,16,11;Normal,,30,RCN;Old films,,39,RCO;clInical correlation,,51,RCC;Flup (mo),17,30,RCF,40,2,PDN;addnt Views,,45,RCi;Ultrasound,,59,RCU;Biopsy,18,30,RCB;Mri,,39,RCm;u/s Core,,45,RCJ" D TT
 S T=";steReotactic,,56,RCR;surgical Eval,19,30,RCE;Histology,,46,RCH;needLe loc,,58,RCL;maGnification,20,30,RCM;Decision to bx,,46,RCD;proJection,21,30,RCP;u/S-fna,,43,RCS;Aspiriration,,53,RCA" D TT
 S T=";spot comPr,22,30,RCG;Take action,,45,RCT" D TT
 S C=X,A="" I $D(BLD) K BLD G ZAA02GSCMRE6
...
LOOP F C=C:0:TS W:C'=A ZAA02G("HI"),TS(C) D RD W ZAA02G("LO"),TS(C) S C=C+$S(ZF="E":99,ZF="F":1,ZF=9:1.1,ZF="A":-1,ZF="B":1,ZF=1:1,ZF="":0,"OP5Y"[ZF:200,1:0),A="" S:C<1 C=TS I C["." F C=C-.1:1:TS Q:$D(TS(C))
 ...
 I $D(ST(0,"CN")),'$D(ST(0,"BN"))&('$D(ST(0,"BB"))) S D="B" G ERR
 I $G(ST(0,"CF"))>11 S D="C" G ERR
