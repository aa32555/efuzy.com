ZAA02GSCMRE7 ;PG&A,ZAA02G-MTS,1.20,MID-ROCKLAND;;;;24MAR99  10:42
...
POP1 S (S,Z,W,SY,TS)=0
 ...
 S DUP="LRB;RP,RF;NA,NL,NR,NB;RF,RA,RU,RB;NB,NP,NS,NH"
 S T="REASON:,12,11;Screening,,30,RAS;Diagnostic,,43,RAP;Follow-up,,57,RAF" D TT
 S T="FINDINGS:,13,11;None,,30,NAN;Asymmetric breasts,,45,MFB;Left abnormal,14,30,MLL;Right abnormal,,46,MLR;Both,,63,MLB" D TT
 S T="RECOMMENDATIONS:,16,11;Routine,,30,RCN;Flup (mo),,40,RCF,50,2,PDN;Addnt views,,55,RCi;Ultrasound,17,30,RCU;Biopsy,,43,RCB;Magnification,,52,RCM;Old films,18,30,RCO;Clinical,,42,RCC;Spot,,53,RCG" D TT
 S T="ASSESSMENT:,19,11;Negative,,30,ABN;Benign,,42,ABB;Probably benign,,52,ABP;Suspicious,20,30,ABS;Highly sugg.,,42,ABM;Addtnl eval,,57,ABA" D TT
 S T="OTHER:,21,11;Tech,,30,OBT,35,12,PD" D TT
 S C=X,A="" I $D(BLD) K BLD G ZAA02GSCMRE7
...
LOOP F C=C:0:TS W:C'=A ZAA02G("HI"),TS(C) D RD W ZAA02G("LO"),TS(C) S C=C+$S(ZF="E":99,ZF="F":1,ZF=9:1.1,ZF="A":-1,ZF="B":1,ZF=1:1,ZF="":0,"OP5Y"[ZF:200,1:0),A="" S:C<1 C=TS I C["." F C=C-.1:1:TS Q:$D(TS(C))
 ...
 F D="A","B","C","D","E" I $E($O(ST(0,D)))'=D G ERR
