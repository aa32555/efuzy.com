ZAA02GSCMREB ;PG&A,ZAA02G-MTS,1.20,CATEGORIES I-IV;;;;01FEB2007  15:20
 ;Copyright (C) 1996, Patterson, Gray and Associates Inc.
 ;
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 S %R=9,%C=9,B="",$P(B,ZAA02G("HL"),64)="" W @ZAA02GP,ZAA02G("G1"),ZAA02G("HI"),ZAA02G("TLC"),B,ZAA02G("TRC") F %R=%R+1:1:20 W @ZAA02GP,ZAA02G("VL"),$J("",63),ZAA02G("VL")
 S %R=%R+1 W @ZAA02GP,ZAA02G("G1"),ZAA02G("BLC"),B,ZAA02G("BRC"),ZAA02G("G0")
 S %R=9,S=$G(INP("PATIENT"))_"  DOB: "_$G(INP("DOB")),%C=-$L(S)\2+40,W=0,NOCLR=1 W @ZAA02GP,ZAA02G("LO"),S
 I $E($O(ST(0,"")))'="A" S ST(0,"AB")=""
POP1 S (S,Z,W,SY,TS)=0
 S T="STUDY:,11,11;Bilateral,,30,TSB;Left,,42,TSL;Right,,49,TSR" D TT
 S DUP="LRB;1234560;NF,NA,NS,NB,NE"
 S T="CATEGORY:,13,11;1-neg,,30,ABN;2-benign,,39,ABB;3-prob benign,,49,ABP;4-susp,14,30,ABS;5-malig,,39,ABM;6-known mal,,49,ABK;0-incomp,,63,ABA" D TT
 S T="RECOMMENDATIONS:,16,11;Normal,,30,RCN;Flup (mo),16,40,RCF,50,2,PDN;Addnt studies,,56,RCi;Sono,17,30,RCU;Biopsy,17,40,RCB;surgical Eval,,56,RCE" D TT
 S T="OTHER:,19,11;Tech,,30,OBT,35,12,PD;Called MD,,50,XXC;Problem indicated,20,30,RAP;Reviewed outside films,,50,RAO" D TT
...
LOOP F C=C:0:TS W:C'=A ZAA02G("HI"),TS(C) D RD W ZAA02G("LO"),TS(C) S C=C+$S(ZF="E":99,ZF="F":1,ZF=9:1.1,ZF="A":-1,ZF="B":1,ZF=1:1,ZF="":0,"OP5Y"[ZF:200,1:0),A="" S:C<1 C=TS I C["." F C=C-.1:1:TS Q:$D(TS(C))
 ...
 I $D(ST(0,"B1")),'$D(ST(0,"CN")) S D="B" G ERR
 I $D(ST(0,"CN")),$D(ST(0,"B1"))+$D(ST(0,"B2"))=0 S D="B" G ERR
