ZAA02GSCMREF ;PG&A,ZAA02G-MTS,1.20,CATEGORIES I-IV;;;;06JAN99  08:25
 ;Copyright (C) 1996, Patterson, Gray and Associates Inc.
 ;
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 S %R=7,%C=9,B="",$P(B,ZAA02G("HL"),62)="" W @ZAA02GP,ZAA02G("G1"),ZAA02G("HI"),ZAA02G("TLC"),B,ZAA02G("TRC") F %R=%R+1:1:19 W @ZAA02GP,ZAA02G("VL"),$J("",61),ZAA02G("VL")
...
POP1 S (S,Z,W,SY,TS)=0
 S T="REASON:,9,11;Screening,,30,RAS;Diagnostic,,43,RAP;Follow-up,,57,RAF" D TT
 S T="STUDY:,11,11;Bilateral,,30,TSB;Left,,43,TSL;Right,,51,TSR" D TT
 S DUP="SDF;LRB;123450;NF,NA,NS,NB,NM,NU"
 S T="CATEGORY:,13,11;0 (incomplete),,30,ABA;1 (negative),,46,ABN;2 (benign),14,30,ABB;3 (probably benign),,46,ABP;4 (suspicious),15,30,ABS;5 (highly sugg. of malig),,46,ABM" D TT
 S T="RECOMMENDATIONS:,17,11;Normal,,30,RCN;Flup (mo),,39,RCF,49,2,PDN;Biopsy,,53,RCB;Mri,,66,RCm;Sono,18,30,RCU;Addnt views,,39,RCi;nUclear med,,53,RCn" D TT
...
LOOP F C=C:0:TS W:C'=A ZAA02G("HI"),TS(C) D RD W ZAA02G("LO"),TS(C) S C=C+$S(ZF="E":99,ZF="F":1,ZF=9:1.1,ZF="A":-1,ZF="B":1,ZF=1:1,ZF="":0,"OP5Y"[ZF:200,1:0),A="" S:C<1 C=TS I C["." F C=C-.1:1:TS Q:$D(TS(C))
 ...
 I $D(ST(0,"C1")),'$D(ST(0,"DN")) S D="C" G ERR
 I $D(ST(0,"DN")),$D(ST(0,"C1"))+$D(ST(0,"C2"))=0 S D="C" G ERR
