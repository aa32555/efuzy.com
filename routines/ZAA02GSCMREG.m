ZAA02GSCMREF ;PG&A,ZAA02G-MTS,1.20,TEANECK RAD;;;;12JAN99  15:07
 ;Copyright (C) 1996, Patterson, Gray and Associates Inc.
 ;
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 S %R=6,%C=9,B="",$P(B,ZAA02G("HL"),62)="" W @ZAA02GP,ZAA02G("G1"),ZAA02G("HI"),ZAA02G("TLC"),B,ZAA02G("TRC") F %R=%R+1:1:19 W @ZAA02GP,ZAA02G("VL"),$J("",61),ZAA02G("VL")
 S %R=%R+1 W @ZAA02GP,ZAA02G("G1"),ZAA02G("BLC"),B,ZAA02G("BRC"),ZAA02G("G0")
 S %R=6,%C=25,W=0,NOCLR=1 W @ZAA02GP,ZAA02G("LO"),"Mammography Examination Screen"
 I $E($O(ST(0,"B")))'="B" S ST(0,"BB")=""
POP1 S (S,Z,W,SY,TS)=0
 S T="REASON:,8,11;Screening,,25,RAS;Diagnostic,,40,RAP" D TT
 S T="STUDY:,10,11;Bilateral,,25,TSB;Left,,40,TSL;Right,,51,TSR" D TT
 S DUP="SD;LRB;123450;AF,AV,AS,AB,AM,AU"
 S T="CATEGORY:,12,11;0 (Incomplete - Need Additional Imaging Eval.),,25,ABA;1 (Negative),13,25,ABN;2 (Benign),,39,ABB;3 (Probably Benign),,52,ABP;4 (Suspicious),14,25,ABS;5 (Highly Sugg. of Malig),,46,ABM" D TT
 S T="RECOMMEND.:,16,11;follow-up according to ACS Guidelines,,25,RCN;Follow-up in    months,17,25,RCF,38,2,PDN;Biopsy,,53,RCB;Mri,,66,RCm;Sono,18,25,RCU;addnt Views,,39,RCi;nUclear med,,53,RCn" D TT
...
LOOP F C=C:0:TS W:C'=A ZAA02G("HI"),TS(C) D RD W ZAA02G("LO"),TS(C) S C=C+$S(ZF="E":99,ZF="F":1,ZF=9:1.1,ZF="A":-1,ZF="B":1,ZF=1:1,ZF="":0,"OP5Y"[ZF:200,1:0),A="" S:C<1 C=TS I C["." F C=C-.1:1:TS Q:$D(TS(C))
 ...
 F D="A","B","C","D" I $E($O(ST(0,D)))'=D G ERR
 I $D(ST(0,"C1")),'$D(ST(0,"DA")) S D="C" G ERR
 I $D(ST(0,"DA")),$D(ST(0,"C1"))+$D(ST(0,"C2"))=0 S D="C" G ERR
...
TT2 S A=$F($TR(C,"ABCDEFGHIJKLMNOPQRSTUVWXYZ1234560","\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"),"\"),L=$E(C,A-1),SS(I_L)=M_$E(C,1,A-2)_ZAA02G("HI")_L_ZAA02G("LO")_$E(C,A,255),L=I_L S:SY SY(L)=""
