ZAA02GSCMREI ;PG&A,ZAA02G-MTS,1.20,CATEGORIES I-IV - FOSTER;;;;09OCT2000  09:37
 ;Copyright (C) 1996, Patterson, Gray and Associates Inc.
 ;
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 S %R=8,%C=9,B="",$P(B,ZAA02G("HL"),64)="" W @ZAA02GP,ZAA02G("G1"),ZAA02G("HI"),ZAA02G("TLC"),B,ZAA02G("TRC") F %R=%R+1:1:20 W @ZAA02GP,ZAA02G("VL"),$J("",63),ZAA02G("VL")
...
POP1 S (S,Z,W,SY,TS)=0
 ...
 S DUP="LRB;123450;NF,NA,NS,NB,NP,NU,MM,NI"
 S T="CATEGORY:,12,11;1 (neg),,30,ABN;2 (benign),,41,ABB;3 (prob benign),,54,ABP;4 (susp),13,30,ABS;5 (malig),,41,ABM;0 (incomplete),,54,ABA" D TT
 S T="RECOMMENDATIONS:,15,11;Normal,,30,RCN;Flup (mo),,40,RCF,50,2,PDN;Addnt studies,,56,RCi;Sono,16,30,RCU;mIraluma,,40,RCn;Prior films,,56,RCO;Mri,17,30,RCm;sUrg eval,,40,RCE" D TT
