ZAA02GSCMREK ;PG&A,ZAA02G-MTS,1.20,CAT 0-V PROMEDICA;;;;09FEB2001  13:53
 ;Copyright (C) 1996, Patterson, Gray and Associates Inc.
 ;
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 S %R=4,%C=9,B="",$P(B,ZAA02G("HL"),62)="" W @ZAA02GP,ZAA02G("G1"),ZAA02G("HI"),ZAA02G("TLC"),B,ZAA02G("TRC") F %R=%R+1:1:22 W @ZAA02GP,ZAA02G("VL"),$J("",61),ZAA02G("VL")
 S %R=%R+1 W @ZAA02GP,ZAA02G("G1"),ZAA02G("BLC"),B,ZAA02G("BRC"),ZAA02G("G0")
 S %R=4,S=$G(INP("PATIENT"))_"  DOB: "_$G(INP("DOB")),%C=-$L(S)\2+40,W=0,NOCLR=1 W @ZAA02GP,ZAA02G("LO"),S
POP1 S (S,Z,W,SY,TS)=0
 S T="STUDY:,6,11;Screening,,25,TSS;Diagnostic,,40,TSB;2nd opinion,,55,TSi;core Biopsy,7,25,TSN;Aspiration,,40,TSC;Comparison,,55,TSg;sTereotactic,8,25,TST;addEndum,,40,TSh" D TT
 S T="u/s Mammotome,9,25,TSa;u/s Per his,,40,TSc;u/s Fam his,,58,TSe;U/s dense,10,25,TSb;u/s palp Lump,,40,TSc;u/s fNb,,58,TSf" D TT
 S DUP="SD,S2,SC,SA,ST,SE,SB,SM,SP,SF,SL,SN,SU,D2,DC,DA,DT,DE,DB,DM,DP,DF,DL,DN,DU,;123450;NF,NB,NS,NM,NV,NU,NC,NA,NT,NO,NL"
 ...
 S T="RECOMMEND:,15,11;Normal,,25,RCN;Flup (mo),,34,RCF,44,2,PDN;Surgical eval,,48,RCB;Mri,,66,RCm;addnt Views,16,25,RCi;Ultrasound,,40,RCU;u/s Core biopsy,,54,RCJ;u/s Aspiration,17,25,RCS;sTereotactic,,44,RCR;Old films,,60,RCO;"
 S T=T_"cLinical correlation,18,25,RCC" D TT
 S T="OTHER (n/r):,20,11;Tech,,25,OBT,30,9,PD;called MD,,42,XXC,54,17,PD;mult prob Alert,21,25,XXM;called Pat.,,42,XXP,54,17,PD" D TT
