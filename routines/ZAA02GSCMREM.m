ZAA02GSCMREM ;PG&A,ZAA02G-MTS,1.20,CAT 0-V BEEKMAN;;25FEB2002  15:12;;10DEC2002  19:24
...
POP1 S (S,Z,W,SY,TS)=0
 ; Mammogram & sonogram both tracked in Mammo stats
 S T="STUDY:,10,11;Mammogram,,25,TSS;Sonogram,,42,TSd;Diag Sono,,54,TSd;u/s Aspiration,11,25,TSC;u/s Core,,42,TSc;sTereotactic,,54,TST" D TT
 S DUP="MD,MS,MA,MC,MT,;123450;NF,NP,NU,NC,NA,NT,NS,NM,NV,ND"
 S T="CATEGORY:,13,11;1 (neg),,25,ABN;2 (benign),,37,ABB;3 (prob benign),,51,ABP;4 (susp),14,25,ABS;5 (malig),,37,ABM;0 (incomplete),,51,ABA" D TT
 S T="RECOMMEND:,16,11;Normal,,25,RCN;Flup (mo),,42,RCF,52,2,PDN;Prior films,,58,RCO;u/s Core biopsy,17,25,RCJ;u/s Aspiration,,42,RCS;Diag u/s,,58,RCU;Surg biopsy,18,25,RCB;Mri,,39,RCm;"
 S T=T_"addnt Views,,44,RCi;sTereotactic,,58,RCR" D TT
 ...
 S C=X,A="" I $D(BLD) K BLD G ZAA02GSCMREM
