ZAA02GSCMREN ;PG&A,ZAA02G-MTS,1.20,FORM E WITH changes;;24FEB2003  22:20;;27FEB2001  13:58
...
POP1 S (S,Z,W,SY,TS)=0
 S T="STUDY:,8,11;Bilateral,,25,TSB;Left,,39,TSL;Right,,49,TSR" D TT
 S DUP="BLR;SDFA;123450;;NF,NB,NT,NC,NS,NM,NU,NO,NM,NR,NS,NP,NV"
 S T="REASON:,10,11;Screening,,25,RAS;Diagnostic,,36,RAP;Follow-up,,48,RAF;Addnl eval,,59,RAA" D TT
 S T="CATEGORY:,12,11;1 (neg),,25,ABN;2 (benign),,38,ABB;3 (prob benign),,53,ABP;4 (susp),13,25,ABS;5 (malig),,38,ABM;0 (incomplete),,53,ABA" D TT
 S T="FINDINGS:,15,11;Mass,,25,NA0;Calcification,,34,NAF;Arch. distortion,,53,AAD" D TT
 S T="RECOMMEND:,17,11;Normal,,25,RCN;Flup (mo),,34,RCF,44,2,PDN;Core biopsy,,48,RCB;Surg eval,,62,RCE;mRi,18,25,RCm;Ultrasound/sonogram,,34,RCU;Old films,,60,RCO"
 S T=T_";Magnification,19,25,RCM;sPot compress,,42,RCG;addnView,,58,RCi" D TT
 S T="OTHER:,21,11;Tech,,25,OBT,30,9,PD;called MD,,42,XXC,52,18,PD;Reviewed outside films,22,25,TSO" D TT
 S C=X,A="" I $D(BLD) K BLD G ZAA02GSCMREN
