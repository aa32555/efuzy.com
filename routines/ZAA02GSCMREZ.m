ZAA02GSCMREZ ;PG&A,ZAA02G-MTS,1.20,OTHER STUDIES;;;;19SEP2005  16:28
 ;Copyright (C) 1996, Patterson, Gray and Associates Inc.
 ;
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 S %R=12,%C=9,B="",$P(B,ZAA02G("HL"),62)="" W @ZAA02GP,ZAA02G("G1"),ZAA02G("HI"),ZAA02G("TLC"),B,ZAA02G("TRC") F %R=%R+1:1:20 W @ZAA02GP,ZAA02G("VL"),$J("",61),ZAA02G("VL")
 S %R=%R+1 W @ZAA02GP,ZAA02G("G1"),ZAA02G("BLC"),B,ZAA02G("BRC"),ZAA02G("G0")
 S Z="TS"_TSU,S="Other Studies",Z=$P($G(@ZAA02GSCMD@("DICT",3,Z)),",",2) S:+Z S=$P($G(@ZAA02GSCMD@("DICT",1,101,+Z)),"^",2) S %R=12,%C=25,W=0,NOCLR=1 W @ZAA02GP,ZAA02G("LO"),S," Exam Screen"
POP1 S (S,Z,W,SY,TS)=0
 S DUP="123450"
 S T="CATEGORY:,14,11;1 (neg),,25,ABN;2 (benign),,37,ABB;3 (prob benign),,51,ABP;4 (susp),15,25,ABS;5 (malig),,37,ABM;0 (incomplete),,51,ABA" D TT
 S T="OTHER (n/r):,17,11;Tech,,25,OBT,30,2,PDU;called MD,,42,XXC,54,17,PD;mult prob Alert,18,25,XXM;called Pat.,,42,XXP,54,17,PD" D TT
 S C=X,A="" I $D(BLD) K BLD G ZAA02GSCMREZ
