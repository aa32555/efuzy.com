ZAA02GSCMRP4 ;PG&A,ZAA02G-MTS,1.20,PATIENT ENTRY SCREEN;06JAN94  22:26;6JAN95 5:43P;;06MAR98  13:56
...
POP D:$D(ZAA02GX)+$D(ZAA02GY)'=2 FUNC^ZAA02GDEV X ^ZAA02G("ECHO-OFF")
 ...
 S %R=2,%C=27,W=0 W @ZAA02GP,ZAA02G("LO"),"Patient Information Screen"
POP1 S TS=0,%R=2,Z=0
 ...
 S %R=6 D LINE
 S T="FAMILY HIST:,7,4;Mother,,17,RBg,24,2,PDN;Post-meno,,27,RBh;Sister,,44,RBi,51,2,PDN;pOst-meno,,54,RBj;Daughter,,69,RBk" D TT
 S T="maternal:,8,6;Grandmother,,17,RBa,29,2,PDN;Aunt,,37,RBb,42,2,PDN;Cousin,,50,RBc,57,2,PDN" D TT
 S T="paternal:,9,6;Grandmother,,17,RBd,29,2,PDN;Aunt,,37,RBe,42,2,PDN;Cousin,,50,RBf,57,2,PDN" D TT
 S %R=10 D LINE
 S T="BR. HIST-L:,11,4;Aspiration,,17,BHA;Needle bx,,29,BHN;Lumpectomy,,40,BHL;Mastectomy,,52,BHM;Radiation,,64,BHR;Other,,74,BHO" D TT
 S T="-R:,12,12;Aspiration,,17,BHa;Needle bx,,29,BHn;Lumpectomy,,40,BHl;Mastectomy,,52,BHm;Radiation,,64,BHr;Other,,74,BHo" D TT
 S T="other:,13,9;Chemo (yy),,17,BHC,28,2,PDN;Prev mammo,,32,BHD,43,10,PD;Where?,,55,BHW,62,16,PD" D TT
 S T="implants:,14,6;siLicone,,17,IBG;Saline,,28,IBS;Pre-pectoral,,37,IBP;Combo,,52,IBC;Retro,,60,IBR;Augment,,68,IBA" D TT
 S %R=15 D LINE
 R A:0 X ZAA02G("T") S ZF=$E(XX,$F(XX,ZF)) G:ZF="E" END
 S T="PROBLEMS:,16,4;palpable Abnormality,,17,IAA;Bl disch,,40,IAB;non-bl Disch,,51,IAD;Exam,,65,IAE;Implant,,72,IAI;Skin thick.,17,17,IAK;Lump,,30,IAL;Nipple abnorm,,36,IAN;Pain,,51,IAP;Cancer,,57,IAW;aXillary nodes,,65,IAX" D TT
 S %R=18 D LINE
 S T="OTHER-Preg:,19,4;number Times pregnant,,17,OTX,39,2,PDN;Children,,44,OTC,53,2,PDN;Age of 1st preg,,58,OTA,74,2,PDN" D TT
 S T=";Pregnant,20,17,OTP;Fertility program,,28,OTF;Nursing,,48,OTN;nursed Lately,,58,OTL" D TT
 S T=" Menses:,21,7;Age at 1st,,17,OPG,28,2,PDN;Menopausal,,34,OTM;Hyster (yy),,55,OTH,67,2,PDN" D TT
 S T="Contra:,22,8;Birth control pills,,17,OFC;Estrogen,,44,OFE;Fertility,,55,OFF;Other,,70,OFO" D TT
 ;
 S DUP="WBIAO"
 ;S %R=18 D LINE S Z=0
...
LOOP F C=C:0:TS W:C'=A ZAA02G("HI"),TS(C) D RD W ZAA02G("LO"),TS(C) S C=C+$S(ZF="E":99,ZF="F":1,ZF=9:1.1,ZF="A":-1,ZF="B":1,ZF=1:1,ZF="":0,"OP5Y"[ZF:200,1:0),A="" S:C<1 C=TS I C["." F C=C-.1:1:TS Q:$D(TS(C))
 ...
 I C>200 S X=C-200 G HLP:ZF="Y",POP1
...
TT2 S A=$F($TR(C,"ABCDEFGHIJKLMNOPQRSTUVWXYZ","\\\\\\\\\\\\\\\\\\\\\\\\\\"),"\"),I=$E(C,A-1),SS(L_I)=M_$E(C,1,A-2)_ZAA02G("HI")_I_ZAA02G("LO")_$E(C,A,255)
 ...
 I $P(D,",",5) S SR(L_I)=%R_","_$P(D,",",5,7),SY=$G(SY)+1,SY(SY)=L_I,%C=$P(D,",",5),LNG=$P(D,",",6) W @ZAA02GP,ZAA02G("HI"),ZAA02G("UO"),$E($G(ST(Z,L_I))_SP,1,LNG),ZAA02G("UF"),ZAA02G("LO")
...
HLP S C=X G:$D(EDIT) LOOP S EDIT=9,TYPS="" G END
 ;
...
PDN S TRM="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz",CHR="1234567890"_TRM
