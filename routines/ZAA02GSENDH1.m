ZAA02GSENDH ;PG&A,ZAA02G-SEND,1.36,HELP SCREENS\;09NOV93  22:16;17FEB92  11:05;28JUL95 4:51P
...
DATA1 S TE="DATA1",HLP="2,5,6," G BEG
 ;*T
 ;` ZAA02G-SEND SCRIPT PROCESSING FACILITY
 ; ZAA02G-SEND allows the user to create, edit and execute scripts that
...
DATA2 S TE="DATA2",HLP="3," G BEG
 ;*T
 ;` ZAA02G-SEND SCRIPT LANGUAGE COMMANDS    (Press EXIT to return)
...
DATA3 S TE="DATA3",HLP="4,2,5," G BEG
 ;*T
 ;` ZAA02G-SEND SCRIPT LANGUAGE COMMANDS - CONTINUED
...
DATA5 S TE="DATA5",HLP="" G BEG
 ;*T
 ;` ZAA02G-SEND SCRIPT COMMANDS - EXAMPLES
...
DATA6 S TE="DATA6",HLP="" G BEG
 ;*T
 ;` ZAA02G-SEND SCRIPT CONVENTIONS
